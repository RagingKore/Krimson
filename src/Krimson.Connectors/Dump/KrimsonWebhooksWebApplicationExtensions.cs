...
//     static WebApplication UseKrimsonWebhookSource(this WebApplication app, IKrimsonWebhook webhook) {
...
//             app.UseKrimsonWebhookSource(webhook);
//
//         return app;
//     }
//     
//     public static WebApplication UseKrimsonWebhookSource<T>(this WebApplication app) where T : IKrimsonWebhook {
//         var webhook = app.Services.GetRequiredService<T>();
//         return app.UseKrimsonWebhookSource(webhook);
//     }
//     
