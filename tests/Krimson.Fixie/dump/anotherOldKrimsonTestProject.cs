...
//                         //             .InitializeAsync(testCaseName, testContextInstance.GetType().Name)
//                         //             .ConfigureAwait(false);
//                         //     }
//                         //     else {
...
//                         //     if (testContextInstance is not null) {
//                         //         await testContextInstance
//                         //             .DisposeAsync(testCaseName, testContextInstance.GetType().Name)
//                         //             .ConfigureAwait(false);
//                         //     }
//                         //     else {
//                         //         await testClassInstance
...
//     }
//
//     // public static async Task InitializeAsync(this IAsyncLifetime source, string testCaseName, string? contextName = null) {
//     //
//     //     try {
//     //         Log.ForContext("SourceContext", nameof(Fixie))
//     //             .Verbose(
//     //                 "Test {TestCaseName} {ContextName} {Operation}", testCaseName, contextName,
//     //                 "initializing"
//     //             );
//     //
...
//     //         Log.ForContext("SourceContext", nameof(Fixie))
//     //             .Verbose(
//     //                 ex, "Test {TestCaseName} {ContextName} {Operation}", testCaseName,
//     //                 contextName, "error"
//     //             );
//     //     }
//     // }
//     //
//     // public static async Task DisposeAsync(this IAsyncLifetime source, string testCaseName, string? contextName = null) {
//     //     try {
//     //         Log.ForContext("SourceContext", nameof(Fixie))
//     //             .Verbose(
//     //                 "Test {TestCaseName} {ContextName} {Operation}", testCaseName, contextName,
